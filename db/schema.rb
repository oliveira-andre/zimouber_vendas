...
ActiveRecord::Schema.define(version: 2019_10_15_195757) do
  ...
  create_table "advertisements", force: :cascade do |t|
    ...
    t.string "slug"
    t.index ["establishment_id"], name: "index_advertisements_on_establishment_id"
  ...
  create_table "establishments", force: :cascade do |t|
    ...
    t.string "trading_name", default: "", null: false
  ...
  add_foreign_key "advertisements", "establishments"
end
